...
const Footer = () => {
  return (
    <footer className=" border-t mt-16 ">
      <div className="px-4 mt-6 py-6  mx-auto max-w-2xl sm:px-6 lg:max-w-6xl ">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-6">
          <div className="md:col-span-2">
            <h1 className="md:text-4xl mb-6 text-2xl font-bold ">
              Bra<span className="text-primary ">Wear</span>
            </h1>
            <p className="max-w-xs">
              Welcome To Our Store We Provided The Best Products with the best
              prices just for you.
            </p>
          </div>
          <div>
            <h3 className=" font-semibold mb-6 mt-2">Categories</h3>
          ...
          <div>
            <h3 className=" font-semibold mb-6 mt-2">Industries</h3>
            <ul className="flex text-sm flex-col gap-3">
              <li>Retail & E-Commerce</li>
              <li>Inforamtion Technology</li>
              <li>Privacy</li>
            </ul>
          </div>
